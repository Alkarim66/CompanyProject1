...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("******************************************************************************");
	        ...
	        //	System.out.println("7-the price of the imported packet of headache pills: 2.99 $ plus 0.05 Tax");
			//	System.out.println("8-the price of the imported Books: 3.99 $ plus 0.05 Tax");
			//	System.out.println("9-the price of the imported CD: 4.99 $ plus 0.15 Tax");
				System.out.println("10-the price of the imported bottle of perfume : 27.99 $ plus 0.15 Tax");
			//	System.out.println("PLEASE MAKE YOUR CHOICE BY PRESSING ONE OF THE NUMBERS 1:LOCAL GOODS OR 2:IMPORTED GOODS OR 3:BUY , 4:Exit ");
		double sumTotal=0.0; 
		double sumTax=0.0;
		int coAray=0;
		...
		int y=0;
			...
			while(x!=1 && x!=2 && x!=3 && x!=4){ // هنا راح يختار بين البضائع المحلية والبضائع المستوردة
